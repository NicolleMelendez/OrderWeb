...
public class ViewTechnician {
    ...
    public String save(@ModelAttribute Technician technician, RedirectAttributes ra)
    {
        ...
        return "redirect:/vista/technician";
    }

    @GetMapping("/vistaT/edit/{id}")
